...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # It's "reduce" or "fold-left"; it runs the block for each item in
    # the list. The non-block argument is used as the initial value for
    # the first parameter to the block.
  end
